...
class DefaultPage extends StatelessWidget {
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  menuItem(
                                      func: () => Get.toNamed(Routes.receipt),
                                      icon: Icons.receipt_long,
                                      route: Routes.receipt),
                                  menuItem(
                                      func: () => Get.toNamed(Routes.expenses),
                                      icon: Icons.bar_chart_rounded,
                                      route: Routes.expenses),
                                  menuItem(
                                      func: () => Get.toNamed(Routes.configs),
                                      icon: Icons.settings,
  ...
  Widget menuItem({
    ...
    return IconButton(
      ...
      icon: Icon(
        icon,
        color: app.isActiveRoute(route) ? Colors.white : Colors.black26,
