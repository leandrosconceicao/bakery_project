...
class ApiRes<T> extends ApiResponse {
  ...
  ApiRes.fromJson(json) : data = json['dados'], super(message: json['message'], result: json['statusProcess']);
  ...
  static ApiRes<T> parseData<T>(Uint8List body, {Function? parser}) {
    try {
      ...
      return ApiRes<T>(
        result: js['statusProcess'],
        message: js['message'],
        data: js["statusProcess"] == true ? (parser != null && js['dados'] != null) ? parser(js['dados']) : null : null);
    } catch (e) {
